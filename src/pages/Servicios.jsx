                  ...
                  <div className="flex flex-col lg:grid lg:grid-cols-3">
                    ...
                    <div className="service-img-panel" style={{
                      ...
                      <img src={s.img} alt={s.title} className="service-img"
                        style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: s.num === "06" ? "right center" : (s.num === "09" || s.num === "07") ? "center bottom" : "center", filter: "brightness(0.55)" }}
                      />
