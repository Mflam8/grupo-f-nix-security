...
const services = [
  ...
  },
  {
    ...
    items: [
      "Adiestramiento para Agentes de Seguridad y Custodios",
      "Adiestramiento para Agentes de Protección a Personalidades Importantes",
      "Políticas, Normas y Procedimientos Preventivos de Seguridad",
      "Adiestramiento en Polígono de Tiro -Teórico y Práctico-",
      "Técnicas de Uso Proporcional de la Fuerza",
      "Uso de Armas No Letales",
      "Derechos Humanos",
      "Adiestramiento de Primeros Auxilios",
      "Adiestramiento de Combate de Incendios",
      "Capacitación de Monitoreo Activo y Sistema de CCTV",
      "Capacitación de Servicio al Cliente",
      "Taller de Cuerdas y Trabajo en Equipo",
      "Charlas de Inclusión Social e Igualdad de Genero",
      "Talleres de Manejo De Crisis",
      "Charlas de Acoso Laboral y Acoso Sexual",
      "Charlas de Prevención de Drogas y Alcohol",
      "Capacitación para Brigadas de Comité de Seguridad y Salud Ocupacional",
    ],
  },
  {
    icon: Users, num: "07",
